...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    NO,  NO,  NO,  NO,       NO,  FN1, FN2, FN3, NO,  NO,  NO,  NO,  NO,  NO,  FN0, NO,  NO,  NO,
    NO,  NO,  NO,  NO,       NO,  FN0, NO,  NO,  NO,  NO,  NO,  NO,  NO,  NO,  NO,  NO,  NO,  NO,
    NO,  NO,  NO,  NO,       NO,  NO,  NO,  FN1, NO,  FN3, NO,  NO,  NO,  NO,  NO,  NO,  FN7,
    FN11,NO,  NO,  NO,       NO,  NO,  NO,  FN2, NO,  NO,  NO,  NO,  NO,  NO,  NO,  NO,
    ...
    NO,       FN12,          TRNS,TRNS,TRNS,               TRNS,          TRNS,TRNS,TRNS
    ),

    /* Keypad gaming layer */
    [L_KP_GAMER_L2] = KEYMAP(
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [11]   = ACTION_LAYER_TOGGLE(L_KP_GAMER),
    [12]  = ACTION_LAYER_MOMENTARY(L_KP_GAMER_L2),
};
