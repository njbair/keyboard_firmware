...
const uint8_t PROGMEM keymaps[][MATRIX_COLS][MATRIX_ROWS] = {
    ...
    /* Remap Ctrl keys */
    [L_OVERLAY_CTRL_REMAP] = KEYMAP_ANSI(
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,        TRNS,TRNS,TRNS,
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,   TRNS,TRNS,TRNS,    TRNS,TRNS,TRNS,TRNS,
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,   TRNS,TRNS,TRNS,    TRNS,TRNS,TRNS,TRNS,
    LCTL,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,                           TRNS,TRNS,TRNS,
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,                  TRNS,         TRNS,TRNS,TRNS,TRNS,
    FN9, TRNS,TRNS,               TRNS,          TRNS,TRNS,TRNS,CAPS,        TRNS,TRNS,TRNS,    TRNS,TRNS
    ),
    ...
    TRNS,FN10,NO,  NO,  NO,  NO,  PPLS,PMNS,END, PGDN,DOWN,TRNS,                  UP,           P1,  P2,  P3,  PENT,
    ...
    TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,                  TRNS,         TRNS,TRNS,TRNS,TRNS,
    LCTL,NO,  TRNS,               TRNS,          TRNS,NO,  NO,  RCTL,        TRNS,TRNS,TRNS,    TRNS,TRNS
    ),
    ...
    FN8, NO,  NO,                 FN7,           NO,  NO,  NO,  FN8,         NO,  NO,  NO,      NO,  NO
    ),
